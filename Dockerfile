...
# --- Build hisat3n from GitHub fork (v0.1.16-dev) ---
WORKDIR /build/hisat2
RUN curl -L https://github.com/y9c/hisat2/archive/4ad56e06efe4ff90844f16ba57dd34bbc26179a5.tar.gz -o hisat2.tar.gz && \
